...
class PoseOutlineGenerator:
    ...
    def process_image(self, input_path, output_dir):
        ...
        try:
            ...
            person_output_path = os.path.join(output_dir, f"{base_name}_person.png")
            outline_output_path = os.path.join(output_dir, f"{base_name}_outline.png")
            pose_output_path = os.path.join(output_dir, f"{base_name}_pose.png")
